...
![equation]([https://latex.codecogs.com/svg.image?|x>=\frac{1}{\left\|x\right\|}\sum&space;_{i=1}^{d}x_i|i>)](https://latex.codecogs.com/svg.image?\;|x\rangle=\frac{1}{\|x\|}\sum_{i=1}^{d}x_i|i\rangle\;)
